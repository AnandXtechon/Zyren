            ...
            <div className="flex flex-col items-center justify-center py-6 gap-5">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                    <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                        <Image
                            ...
                            height={25}
                        />
                        <h1 className="text-white text-xl font-medium">Increased Productivity</h1>
                    ...
                    <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                        <Image
                            ...
                            height={25}
                        />
                        <h1 className="text-white text-xl font-medium">Better Customer Experience</h1>
                    ...
                    <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                        <Image
                            ...
                            height={20}
                        />
                        <h1 className="text-white text-xl font-medium">24/7 Availability</h1>
                ...
                <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                    <Image
                        ...
                        height={25}
                    />
                    <h1 className="text-white text-xl font-medium">Cost Reduction</h1>
                ...
                <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                    <Image
                        ...
                        height={25}
                    />
                    <h1 className="text-white text-xl font-medium">Data-Driven Insights</h1>
                ...
                <div className="border border-zinc-900 rounded-lg p-6 w-[400px] relative overflow-hidden">
                    <Image
                        ...
                        height={25}
                    />
                    <h1 className="text-white text-xl font-medium">Scalability & Growth</h1>
